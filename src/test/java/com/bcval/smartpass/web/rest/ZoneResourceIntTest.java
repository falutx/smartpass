...
import com.bcval.smartpass.repository.ZoneRepository;
...
public class ZoneResourceIntTest {
    ...
    public void createZone() throws Exception {
        ...
        assertThat(testZone.getPrice()).isEqualTo(DEFAULT_PRICE);
    }
    ...
    public void updateZone() throws Exception {
        ...
        assertThat(testZone.getPrice()).isEqualTo(UPDATED_PRICE);
    }
