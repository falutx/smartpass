    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="smartpassApp.zone.home.createOrEditLabel">
              <Translate contentKey="smartpassApp.zone.home.createOrEditLabel">Create or edit a Zone</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : zoneEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="zone-name" type="text" name="name" />
                </AvGroup>
                <AvGroup>
                  <Label id="priceLabel" for="price">
                    <Translate contentKey="smartpassApp.zone.price">Price</Translate>
                  </Label>
                  <AvField id="zone-price" type="text" name="price" />
                </AvGroup>
