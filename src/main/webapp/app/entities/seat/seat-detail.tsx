...
export interface ISeatDetailProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="smartpassApp.seat.detail.title">Seat</Translate> [<b>{seatEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            ...
            <dd>{seatEntity.zone ? seatEntity.zone.id : ''}</dd>
          </dl>
